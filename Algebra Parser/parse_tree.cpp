...
double Addition_Node::evaluate(double x)
{
...
double Subtraction_Node::evaluate(double x)
{
    return left->evaluate(x) - right->evaluate(x);
}
...
double Multiplication_Node::evaluate(double x)
{
    return left->evaluate(x) * right->evaluate(x);
}
...
double Division_Node::evaluate(double x)
{
    return left->evaluate(x) / right->evaluate(x);
}
...
double Exponentiation_Node::evaluate(double x)
{
...
double Function_Node::evaluate(double x)
{
    return (*func)(x);
}
...
double X_Node::evaluate(double x)
{
    return x;
}
...
double Constant_Node::evaluate(double x)
{
    return value;
}